package com.shuzhengit.zhixin.view.wheel;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected View makeHeaderView() {
        ...
        int height = DeviceUtil.dp2px(activity, topHeight);
        ...
        int padding = DeviceUtil.dp2px(activity, topPadding);
        ...
        if (null == titleView) {
            ...
            int margin = DeviceUtil.dp2px(activity, topPadding);
