...
public class hongbao extends RelativeLayout {
    ...
    public hongbao(Activity activity) {
        super(activity);
        LayoutInflater.from(activity).inflate(R.layout.activity_hongbao, this);
        setBackgroundResource(R.mipmap.hongbao);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (isScroll) {
                    ...
                    // setBackgroundDrawable(openDrawable);
                    // invalidate();
                    getContext().startActivity(new Intent(getContext(), MoneyActivity.class));
                }
                isScroll = false;
