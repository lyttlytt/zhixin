...
///**
// * Created by 江苏镇江树正科技 .
// * Author：袁从斌 on 2017/10/30 10:33
...
//    private List<WenBa> data = new ArrayList<>();
//
...
//        holder.tvAnswerCount.setText(String.format(ResourceUtils.getResourceString(APP.getInstance(),R.string
//                .questionAnswerCount),question.getAnswerCount()));
//        GlideLoadImageUtils.loadImg(mContext,question.getImages().get(0),holder.ivBanner,R.drawable.loading_img);
//    }
//
//    @Override
