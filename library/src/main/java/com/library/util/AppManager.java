...
public class AppManager {
     ...
     * 功能描述: 添加Activity到堆栈
     *
     * @param activity add to activityStack
     */
     ...
     * 功能描述: 结束指定的Activity
     *
     * @param activity close designation activity for activity
     */
     ...
     * 功能描述: 移除指定的Activity
     *
     * @param activity remove from activityStack
     */
     ...
     *
     * @param cls close designation activity  for activity class
     */
